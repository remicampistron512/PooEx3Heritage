...
public class TestEmployee {
    public static void main (String [] args) {
        ...
        List<Employee> staff = new ArrayList<>(List.of(
                ...
                new Employee("Diego",   "Lopez",    32, "Calle de Alcalá 23, Madrid",     madrid,   "Hooli",       51000),
                new Employee("Elena",   "Rossi",    27, "Via dei Fori Imperiali, Rome",   rome,     "Umbrella",    39000),
                new Employee("François","Petit",    45, "Boulevard Voltaire, 75011 Paris",paris,    "Wayne Tech",  62000)
        ));
